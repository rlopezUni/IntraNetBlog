...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $role3 = Role::create(['name' => 'Usuarios']);
        ...
        Permission::create(['name' => 'posts.index'])->syncRoles([$role1,$role2,$role3]);
        Permission::create(['name' => 'posts.create'])->syncRoles([$role1,$role2,$role3]);
        Permission::create(['name' => 'posts.edit'])->syncRoles([$role1,$role2,$role3]);
        Permission::create(['name' => 'posts.destroy'])->syncRoles([$role1,$role2,$role3]);
